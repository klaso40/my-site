<template>
  <svg id="rocket-image" class="w-max" viewBox="0 0 1136 815">
    <g id="rocket 1" clip-path="url(#clip0)">
      ...
      <g id="rocket">
        ...
        <path
          id="Vector_42"
          d="M628.19 649.4H627.54C624.479 649.4 621.544 648.184 619.38 646.02C617.216 643.856 616 640.921 616 637.86V585H639.73V637.86C639.73 640.921 638.514 643.856 636.35 646.02C634.186 648.184 631.251 649.4 628.19 649.4Z"
          fill="url(#paint5_linear)"
        />
        <path
          id="Vector_43"
          d="M425.19 649.4H424.54C421.479 649.4 418.544 648.184 416.38 646.02C414.216 643.856 413 640.921 413 637.86V585H436.73V637.86C436.73 640.921 435.514 643.856 433.35 646.02C431.186 648.184 428.251 649.4 425.19 649.4Z"
