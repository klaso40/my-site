    ...
    >
      ...
      <nuxt-link v-show="expanded" to="/" class="link">
        <svg class="fill-current w-6" viewBox="0 1 511 511.999">
          ...
          /></svg
      ></nuxt-link>
      <nuxt-link v-show="expanded" to="/web-development" class="link"
        ><svg class="fill-current w-6" viewBox="0 -25 424 424">
          ...
          /></svg
      ></nuxt-link>
      <nuxt-link v-show="expanded" to="/app-development" class="link"
        ><svg class="fill-current w-6" viewBox="0 0 512 512">
          <g>
            ...
            <path
              d="m284.116 209.14a8 8 0 0 0 -10.976 2.744l-48 80a8 8 0 1 0 13.72 8.232l48-80a8 8 0 0 0 -2.744-10.976z"
            />
            <path
              d="m310.247 211a8 8 0 0 0 -12.494 10l28 35-28 35a8 8 0 0 0 12.494 10l32-40a8 8 0 0 0 0-10z"
            />
            <path
              d="m201.753 301a8 8 0 1 0 12.494-10l-28-35 28-35a8 8 0 1 0 -12.494-10l-32 40a8 8 0 0 0 0 10z"
            />
          </g></svg
      ></nuxt-link>
